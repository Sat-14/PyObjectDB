...
greater detail, explaining advanced uses of the PyObjectDB and  how it's actually
implemented.  A definitive reference, and highly recommended.  ---
`<http://www.python.org/workshops/2000-01/proceedings/papers/fulton/PyObjectDB3.html>`_

Persistent Programing with PyObjectDB, by Jeremy Hylton and Barry Warsaw:  ---  Slides
