This directory contains a collection of utilities for managing PyObjectDB
databases.  Some are more useful than others.  If you install PyObjectDB
...
PyObjectDBload.py -- exercise PyObjectDB under a heavy synthesized Zope-like load

See the module docstring for details.  Note that this script requires
Zope.  New in PyObjectDB3 3.1.4.
