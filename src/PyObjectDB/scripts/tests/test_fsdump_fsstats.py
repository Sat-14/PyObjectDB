...
from PyObjectDB.scripts.fsstats import rx_data
from PyObjectDB.scripts.fsstats import rx_txn
from PyObjectDB.tests.util import TestCase
from PyObjectDB.tests.util import run_module_as_script
...
class FsdumpFsstatsTests(TestCase):
    ...
    def test_fsdump(self):
        run_module_as_script("PyObjectDB.FileStorage.fsdump", ["data.fs"])
    ...
    def test_fsstats(self):
        ...
        run_module_as_script("PyObjectDB.FileStorage.fsdump", ["data.fs"],
                             "data.dmp")
        run_module_as_script("PyObjectDB.scripts.fsstats", ["data.dmp"])
        with open("stdout") as f:
