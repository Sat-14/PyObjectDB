...
#
##############################################################################
"""Support for PyObjectDB object serialization.

PyObjectDB serializes objects using a custom format based on Python pickles.
...
PyObjectDB stores serialized objects using a custom format based on pickle.
...
- PyObjectDB/utils.py's get_pickle_metadata() tries to return the module and
...
PyObjectDB persistent references are of the form::
...
from PyObjectDBpickle import binary

from PyObjectDB import broken
from PyObjectDB._compat import PersistentPickler
...
# from PyObjectDB.coptimizations import new_persistent_id
...
class ObjectWriter:
    ...
    The ObjectWriter creates object pickles in the PyObjectDB format.  It
    ...
    def persistent_id(self, obj):
        ...
        >>> from PyObjectDB.tests.util import P
        ...
        The oid in the persistent id is of the PyObjectDBpickle binary type:
        ...
        Traceback (most recent call last):
          ...
        PyObjectDB.POSException.InvalidObjectReference:
        ('Attempt to store an object from a foreign database connection',
        <PyObjectDB.serialize.DummyJar ...>, P(bob))
...
class ObjectReader:
    ...
    def getState(self, pickle):
        ...
        try:
            ...
            log = logging.getLogger("PyObjectDB.serialize")
