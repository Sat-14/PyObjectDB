...
class ConflictResolvingStorage:
    ...
    def testZClassesArentResolved(self):
        from PyObjectDB.ConflictResolution import BadClassName
        from PyObjectDB.ConflictResolution import find_global
    ...
    def testBuggyResolve1(self):
        ...
        revid1 = self._dostoreNP(oid, data=PyObjectDB_pickle(obj))
        ...
        self._dostoreNP(oid, revid=revid1, data=PyObjectDB_pickle(obj))
        self.assertRaises(ConflictError,
                          self._dostoreNP,
                          oid, revid=revid1, data=PyObjectDB_pickle(obj))
