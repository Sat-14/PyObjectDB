...
import PyObjectDB
import PyObjectDB.fsrecover
import PyObjectDB.tests.util
from PyObjectDB.FileStorage import FileStorage


class RecoverTest(PyObjectDB.tests.util.TestCase):
    ...
    def testNoDamage(self):
        ...
        self.assertIn('\n0 bytes removed during recovery', output, output)
    ...
    def testUncommittedAtEnd(self):
        ...
        # infinite loop in fsrecover.py.  Also, in the PyObjectDB 3.2 line,
        ...
        os.remove(PyObjectDB.fsrecover._trname)
