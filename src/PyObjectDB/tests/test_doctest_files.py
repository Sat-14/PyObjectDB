...
__test__ = dict(
    ...
    >>> import PyObjectDB.tests.util, persistent.mapping, transaction
    >>> dbs = {}
    >>> db1 = PyObjectDB.tests.util.DB(database_name='', databases=dbs)
    >>> db2 = PyObjectDB.tests.util.DB(database_name='2', databases=dbs)
    >>> conn1 = db1.open()
