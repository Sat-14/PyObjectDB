...
class PMTests(unittest.TestCase):
    ...
    def testOldStyleRoot(self):
        # The Persistence module doesn't exist in Zope3's idea of what PyObjectDB
    ...
    def testBackwardCompat(self):
        # Verify that the sanest of the PyObjectDB 3.2 dotted paths still works.
        from persistent.mapping import PersistentMapping as newPath

        from PyObjectDB.PersistentMapping import PersistentMapping as oldPath
    ...
    # PersistentMapping didn't have an __iter__ method before PyObjectDB 3.4.2.
