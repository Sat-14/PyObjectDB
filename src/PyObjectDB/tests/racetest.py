...
invariant. This checker verifies storages and PyObjectDB.Connection for races in
between load/open and local invalidations to catch bugs similar to
https://github.com/zopefoundation/PyObjectDB/issues/290 and
...
from PyObjectDB.tests.util import long_test
from PyObjectDB.tests.util import with_high_concurrency
from PyObjectDB.utils import at2before
from PyObjectDB.utils import tid_repr
...
class RaceTests:
    ...
    # invalidations.
    # https://github.com/zopefoundation/ZEO/issues/166
    # https://github.com/zopefoundation/PyObjectDB/issues/290
...
# `_state_details` returns text details about PyObjectDB objects directly referenced
# by root.
