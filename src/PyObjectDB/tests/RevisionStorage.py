...
class RevisionStorage:
    ...
    def testLoadSerial(self):
        ...
        for revid, value in revisions.items():
            ...
            self.assertEqual(PyObjectDB_unpickle(data), value)
    ...
    def testLoadBeforeEdges(self):
        ...
        self.assertEqual(PyObjectDB_unpickle(data), MinPO(1))
    ...
    def testLoadBeforeOld(self):
        ...
        self.assertEqual(PyObjectDB_unpickle(data), MinPO(11))
    ...
    def testLoadBeforeConsecutiveTids(self):
        ...
        def helper(tid, revid, x):
            data = PyObjectDB_pickle(MinPO(x))
        ...
        eq(PyObjectDB_unpickle(data), MinPO(1))
        eq(u64(start_tid), 1)
        eq(u64(end_tid), 2)
