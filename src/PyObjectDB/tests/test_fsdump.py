...
>>> from PyObjectDB.FileStorage.fsdump import fsdump  # we're testing this
...
>>> db = PyObjectDB.DB(st) # yes, that creates a root object!
...
checker = renormalizing.RENormalizing([
    ...
    # Python 3 produces larger pickles, even when we use PyObjectDBpickle :(
...
def test_suite():
    return doctest.DocTestSuite(
        ...
        checker=PyObjectDB.tests.util.checker + checker)
