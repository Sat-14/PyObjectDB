...
from PyObjectDB import serialize
...
class SerializerTestCase(unittest.TestCase):
    ...
    def test_protocol_3_binary_handling(self):
        from PyObjectDB.serialize import _protocol
...
class SerializerFunctestCase(unittest.TestCase):
    ...
    def test_funky_datetime_serialization(self):
        ...
        prep_args = [sys.executable, '-c',
                     'from PyObjectDB.tests.testSerialize import _functest_prep; '
        ...
        load_args = [sys.executable, '-c',
                     'from PyObjectDB.tests.testSerialize import _functest_load; '
...
def test_suite():
    return unittest.TestSuite((
        ...
        doctest.DocTestSuite("PyObjectDB.serialize",
