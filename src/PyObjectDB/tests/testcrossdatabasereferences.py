...
database open function, but this doesn't work:
    ...
    >>> import PyObjectDB.tests.util, transaction
    >>> databases = {}
    >>> db1 = PyObjectDB.tests.util.DB(databases=databases, database_name='1')
    >>> db2 = PyObjectDB.tests.util.DB(databases=databases, database_name='2')
    ...
    <PyObjectDB.Connection.Connection object at ...>,
    <PyObjectDB.tests.testcrossdatabasereferences.MyClass object at ...>)
...
def test_suite():
    return unittest.TestSuite((
        ...
        doctest.DocTestSuite(checker=PyObjectDB.tests.util.checker),
    ))
