...
http://www.zope.org/Documentation/Developer/Models/PyObjectDB/PyObjectDB_Architecture_Storage_Interface_Info.html
...
from PyObjectDB.tests.racetest import RaceTests
...
class BasicStorage(RaceTests):
    ...
    def testStoreAndLoad(self):
        ...
        data, revid = utils.load_current(self._storage, oid)
        eq(PyObjectDB_unpickle(data), MinPO(21))
    ...
    def testWriteAfterAbort(self):
        ...
        t = TransactionMetaData()
        self._storage.tpc_begin(t)
        self._storage.store(oid, ZERO, PyObjectDB_pickle(MinPO(5)), '', t)
