...
PyObjectDB guarantees execution-time consistency: A single transaction will
...
>>> from PyObjectDB.tests.test_storage import MinimalMemoryStorage
...
>>> from PyObjectDB.utils import p64, u64
...
The PyObjectDB Connection tracks a transaction high-water mark, which
...
Traceback (most recent call last):
 ...
PyObjectDB.POSException.ConflictError: database conflict error (oid 0x01, class PyObjectDB.tests.MinPO...
...
sees.  Before PyObjectDB 3.4.1, the internal TmpStore used when savepoints are
...
why PyObjectDB no-longer calls load. :)
...
Traceback (most recent call last):
 ...
PyObjectDB.POSException.ReadConflictError: ...
