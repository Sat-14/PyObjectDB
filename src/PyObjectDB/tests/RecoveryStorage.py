...
from PyObjectDB.tests.IteratorStorage import IteratorDeepCompare
...
class RecoveryStorage(IteratorDeepCompare):
    ...
    def testRestoreWithMultipleObjectsInUndoRedo(self):
        ...
        # Undo creates backpointers in (at least) FileStorage.  PyObjectDB 3.2.1
        ...
        if is_filestorage:
            ...
            self.assertGreater(self._storage._data_find(pos, obj1_oid, ''), 0)
            self.assertGreater(self._storage._data_find(pos, obj2_oid, ''), 0)
