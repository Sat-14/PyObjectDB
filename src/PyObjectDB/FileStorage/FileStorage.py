...
from PyObjectDB._compat import FILESTORAGE_MAGIC
from PyObjectDB._compat import Pickler
from PyObjectDB._compat import _protocol
from PyObjectDB._compat import loads
from PyObjectDB.BaseStorage import BaseStorage
from PyObjectDB.BaseStorage import DataRecord as _DataRecord
from PyObjectDB.BaseStorage import TransactionRecord as _TransactionRecord
from PyObjectDB.blob import BlobStorageMixin
from PyObjectDB.blob import link_or_copy
from PyObjectDB.blob import remove_committed
from PyObjectDB.blob import remove_committed_dir
from PyObjectDB.ConflictResolution import ConflictResolvingStorage
from PyObjectDB.FileStorage.format import DATA_HDR
from PyObjectDB.FileStorage.format import DATA_HDR_LEN
from PyObjectDB.FileStorage.format import TRANS_HDR
from PyObjectDB.FileStorage.format import TRANS_HDR_LEN
from PyObjectDB.FileStorage.format import CorruptedDataError
from PyObjectDB.FileStorage.format import CorruptedError
from PyObjectDB.FileStorage.format import DataHeader
from PyObjectDB.FileStorage.format import FileStorageFormatter
from PyObjectDB.FileStorage.format import TxnHeader
from PyObjectDB.FileStorage.fspack import FileStoragePacker
from PyObjectDB.fsIndex import fsIndex
from PyObjectDB.interfaces import IBlobStorageRestoreable
from PyObjectDB.interfaces import IExternalGC
from PyObjectDB.interfaces import IStorage
from PyObjectDB.interfaces import IStorageCurrentRecordIteration
from PyObjectDB.interfaces import IStorageIteration
from PyObjectDB.interfaces import IStorageRestoreable
from PyObjectDB.interfaces import IStorageUndoable
from PyObjectDB.POSException import ConflictError
from PyObjectDB.POSException import MultipleUndoErrors
from PyObjectDB.POSException import POSKeyError
from PyObjectDB.POSException import ReadOnlyError
from PyObjectDB.POSException import StorageError
from PyObjectDB.POSException import StorageSystemError
from PyObjectDB.POSException import StorageTransactionError
from PyObjectDB.POSException import UndoError
from PyObjectDB.utils import as_bytes
from PyObjectDB.utils import as_text
from PyObjectDB.utils import cp
from PyObjectDB.utils import load_current
from PyObjectDB.utils import mktemp
...
logger = logging.getLogger('PyObjectDB.FileStorage')
...
class FileStorage(
    ...
    def __init__(self, file_name, create=False, read_only=False, stop=None,
        ...
        :param bytes stop: Time-travel transaction id
            ...
            :class:`~PyObjectDB.TimeStamp.TimeStamp`.
        ...
        :param callable packer: An alternative
           :interface:`packer <PyObjectDB.FileStorage.interfaces.IFileStoragePacker>`.
    ...
    def undoLog(self, first=0, last=-20, filter=None):
        if last < 0:
            ...
            # instead -- off by 1), until PyObjectDB 3.4.
            last = first - last
        with self._lock:
...
def read_index(file, name, index, tindex, stop=b'\377' * 8,
    ...
    maxoid -- ignored (it meant something prior to PyObjectDB 3.2.6; the argument
