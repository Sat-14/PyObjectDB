...
class PackError(PyObjectDB.POSException.POSError):
    pass
...
class GC(FileStorageFormatter):
    ...
    def __init__(self, file, eof, packtime, gc, referencesf):
        ...
        self.oid2curpos = PyObjectDB.fsIndex.fsIndex()
        ...
        self.reachable = PyObjectDB.fsIndex.fsIndex()
        self.reach_ex = {}
    ...
    def buildPackIndex(self):
        ...
        if th.status == 'p':
            ...
            from PyObjectDB.FileStorage.FileStorage import RedundantPackWarning
...
class FileStoragePacker(FileStorageFormatter):
    ...
    def __init__(self, storage, referencesf, stop, gc=True):
        ...
        self.index = PyObjectDB.fsIndex.fsIndex()
        self.tindex = {}
        self.oid2tid = {}
        self.toid2tid = {}
